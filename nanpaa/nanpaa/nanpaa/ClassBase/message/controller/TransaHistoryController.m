...
- (void)tixianAction{
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"No Mail Accounts" message:@"When your earnings reach 50000 points, please contact nanpaa customer service to mention the relevant information \n\n Service Email \nNanpaa@bianker.com" delegate:self cancelButtonTitle:@"OK" otherButtonTitles: nil];
        alert.tag = 101;
        [alert show];
}

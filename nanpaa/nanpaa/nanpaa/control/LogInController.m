    ...
    ______WS();
        ...
        [[DJHttpApi shareInstance] POST:LoginUrl dict:par succeed:^(id data) {
            if ([[NSString stringWithFormat:@"%@",data[@"rspCode" ]] isEqualToString:@"10000"]) {
                if ([[NSUserDefaults standardUserDefaults] objectForKey:@"sendUser_success"] != nil){
                ...
                [[DJHManager shareManager] toastManager:@"wrong Account or Password" superView:wSelf.view];
            }

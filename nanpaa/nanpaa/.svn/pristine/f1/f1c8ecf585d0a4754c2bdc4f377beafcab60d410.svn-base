...
- (void)initUI{
    ...
    [topView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(wSelf.view.mas_top).offset(94);
    }];
...
- (void)buyingOrBeginBuyAction{
    for (int i = 101; i < 107; i++) {
        PayMentView *view = [self.view viewWithTag:i];

...
- (void)setupUI {
    ...
    self.flashSwitch = ({
        ...
        [b setBackgroundImage:[UIImage imageNamed:@"sgdGuan"] forState:UIControlStateNormal];
        [b setBackgroundImage:[UIImage imageNamed:@"sgdKai"] forState:UIControlStateSelected];
...
- (void)viewWillLayoutSubviews {
    ...
    self.downButton.bounds = CGRectMake(0, 0, 40, 40);
    self.recaptureButton.center = CGPointMake(60, self.downButton.center.y);
    self.recaptureButton.bounds = CGRectMake(0, 0, 40, 40);
}
...
//                weakSelf.imageView.hidden = NO;
                ...
                [[NSNotificationCenter defaultCenter] postNotificationName:[[NSUserDefaults standardUserDefaults] objectForKey:@"postHome"] object:weakSelf userInfo:dic];
...
//                [_avplayer.player play];
                [[NSNotificationCenter defaultCenter] postNotificationName:[[NSUserDefaults standardUserDefaults] objectForKey:@"postHome"] object:weakSelf userInfo:nil];
                [weakSelf dismissViewControllerAnimated:YES completion:nil];

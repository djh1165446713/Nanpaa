...
#define QVBIAN_SHAREURL   @"http://www.nanpaa.com"
...
//    NSArray* imageArr = @[[UIImage imageNamed:@"placeholderImg.png"]];
    ...
    [shareParams SSDKSetupShareParamsByText:@"分享内容"
                                     images:[UIImage imageNamed:@"传入的图片名"]
                                        url:[NSURL URLWithString:QVBIAN_SHAREURL]
                                      title:@"分享标题"
                                       type:SSDKContentTypeAuto];
        
        [shareParams SSDKSetupMailParamsByText:text
                                         title:title
                                        images:nil
                                   attachments:nil
                                    recipients:nil
        ...
        [shareParams SSDKSetupFacebookParamsByText:text image:nil type:SSDKContentTypeAuto];
    
        [shareParams SSDKSetupSMSParamsByText:text title:title images:nil attachments:QVBIAN_SHAREURL recipients:nil type:SSDKContentTypeAuto];

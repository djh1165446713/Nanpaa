...
- (void)viewDidLoad {
    ...
    [_beautifyBt setBackgroundImage:[UIImage imageNamed:@"meiyanK"] forState:(UIControlStateNormal)];
    ...
    _recordBt.image = [UIImage imageNamed:@"videoPointNor"];
...
- (void)tapAction:(UITapGestureRecognizer*)sender {
    ...
    if (_isVideoIng) {
        ...
        _isVideoIng = YES;
        _recordBt.image = [UIImage imageNamed:@"videoPointSel"];
...
-(void)beautifyClick:(UIButton *)sender{
    ...
    if (sender.selected) {
        ...
        [_beautifyBt setBackgroundImage:[UIImage imageNamed:@"meiyanG"] forState:(UIControlStateNormal)];

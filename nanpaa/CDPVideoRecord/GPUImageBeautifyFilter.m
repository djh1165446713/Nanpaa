...
(
 ...
 void main()
 {
     ...
     smooth.r = log(1.0 + 0.2 * smooth.r)/log(1.3);
     smooth.g = log(1.0 + 0.2 * smooth.g)/log(1.3);
     smooth.b = log(1.0 + 0.2 * smooth.b)/log(1.3);
     gl_FragColor = smooth;
 }
 );
...
- (id)init;
{
    ...
    // 设置锐化度
    bilateralFilter.distanceNormalizationFactor = 3.0;
